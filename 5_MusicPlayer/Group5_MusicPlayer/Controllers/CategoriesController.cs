...
namespace Group5_MusicPlayer.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(MusicPlayerDbContext context, IHubContext<SignalrServer> signalRHub)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'MusicPlayerDbContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusicPlayerDbContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
